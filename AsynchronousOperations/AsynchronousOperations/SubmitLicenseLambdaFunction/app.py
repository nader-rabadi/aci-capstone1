...
def lambda_handler(event, context):
    ...
    event: SQS message, which was written by SendSuccess State. The message was created
           by WriteToDynamoLambdaFunction. See also $.notification in YAML template.
